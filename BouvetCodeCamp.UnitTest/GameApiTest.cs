...
namespace BouvetCodeCamp.UnitTest
{
    ...
    public class GameApiTest
    {
        ...
        private readonly Mock<IAktivitetsLoggService> _aktivitetsLoggService = new Mock<IAktivitetsLoggService>();
 
        [SetUp]
        public void Setup()
        {
            _gameApi = new GameApi(_kodeService.Object, _lagService.Object, _aktivitetsLoggService.Object);
        }
